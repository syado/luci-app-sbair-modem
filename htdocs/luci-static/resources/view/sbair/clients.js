...
function clientTable(list, sortKey, sortDir, onSort, onSaveNote, onScan) {
	if (!list || !list.length)
...
function render(data, opts) {
	...
	body.push(sbair.section('接続機器 (' + ((data.clients || []).length) + '台)', [
		clientTable(data.clients, opts.sortKey, opts.sortDir, opts.onSort, opts.onSaveNote, opts.onScan)
	]));
